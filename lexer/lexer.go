...
type Lexer struct {
	...
	readPosition int  // current read position input (after current char)
...
// skipWhitespace ignores all whitespace
...
// peekChar returns the next character, but doesn't increment the position
